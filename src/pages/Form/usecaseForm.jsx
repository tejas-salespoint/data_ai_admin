...
import {CREATE_INDUSTRY_USECASES, GET_INDSUTRIES_PILLERS} from "../../../graphql/query/queries.js";
...
const usecaseForm = () => {
    ...
    const [createIndustryUseCase, {loading}] = useMutation(CREATE_INDUSTRY_USECASES);
    const {data: indsutryPillerData, loading: industryPillerLoading} = useQuery(GET_INDSUTRIES_PILLERS);
    ...
    return (
        ...
        <div className="m-3 mx-6">
             <BackButton/>
            <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create an Industry Use Cases</h2>
            <form
                ...
                <div className={"grid gap-4  sm:gap-6"}>
                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <TextInput
                            ...
                            setValue={(value) => setFormData({...formData, usecaseTitle: value})}
                        />
                        ...
                        <SelectInput
                            ...
                            setValue={(value) => setFormData({...formData, industryPillarId: value})}
                            options={options}
                        />
                    </div>

                    <div>
                        <label htmlFor={'keyHighlights'}
                        ...
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 border rounded-2xl p-6">
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, decisionMakers: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, decisionMakersFactors: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, desiredBusinessObjectives: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, customerPainPoints: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, proposedTechnicalSolution: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, otherNotableAttributes: value})}
                                />
                            </div>
                            ...
                            <div>
                                <DynamicInputFields
                                    ...
                                    setValue={(value) => setFormData({...formData, products: value})}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <label htmlFor={'idealCustomerProfile'}
                               className="block mb-4 text-sm text-blue-500 font-semibold dark:text-white">
                            Ideal Customer Profile
                        </label>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 border rounded-2xl p-6">
                            <TextInput
                                ...
                                setValue={(value) => setFormData({...formData, industryName: value})}
                            />
                            <TextInput
                                label="Geography"
                                name="geography"
                                ...
                                setValue={(value) => setFormData({...formData, geography: value})}
                            />
                            <TextInput
                                label="Market Cap"
                                name="marketCap"
                                ...
                                setValue={(value) => setFormData({...formData, marketCap: value})}
                            />
                            <TextInput
                                label="Employees"
                                name="employees"
                                ...
                                setValue={(value) => setFormData({...formData, employees: value})}
                            />
                            <TextInput
                                label="Budget"
                                name="budget"
                                ...
                                setValue={(value) => setFormData({...formData, budget: value})}
                            />
                            <TextInput
                                label="Image Link"
                                name="imageLink"
                                ...
                                setValue={(value) => setFormData({...formData, imageLink: value})}
                            />
                            <TextInput
                                ...
                                setValue={(value) => setFormData({...formData, imageSubtitle: value})}
                            />
                        </div>
                    </div>
                </div>
