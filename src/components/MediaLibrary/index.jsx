...
export default function ModelLibrary({ setImageId, imageid, type }) {
  ...
  return (
    <>
      ...
      {!type ? (
        ...
        <div
          className="flex items-center w-full sm:col-span-2 pattern-paper pattern-yellow-500 pattern-bg-white 
        pattern-size-16 pattern-opacity-20"
          onClick={onClick}
        >
          <label className="flex flex-col px-5  border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div className="flex flex-row  items-center  gap-5 pt-5 pb-6 relative">
              <svg
            ...
            /> */}
              {imageid?.url && (
                <img
                  srcSet={imageid.url}
                  className={`rounded-lg object-scale-down  h-20 w-20 bg-transparent`}
                  alt="image description"
                />
              )}
            </div>
